...
// Universal HTTP auth middleman: attaches access tokens, retries once on 401 after refresh, prevents token races (single-flight), clones and replays the original request
...
namespace Demo.AuthRetry
{
     ...
     * v2 adds a header-based replay marker to guarantee "retry once".
    =====================================================================*/
    public sealed class AuthRetryHandler : DelegatingHandler
    {
        // Marks a replay so we never retry more than once even across handler chains
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken ct)
        {
            ...
            try
            {
                ...
                // mark this as a replay so we never retry again
        ...
        //Deepclone a request so it can be replayed
